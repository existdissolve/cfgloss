<cfcomponent output="false" displayname="jre-utils v0.7">
	...
	<cffunction name="init" output="false" access="public">
		...
		<cfset This.SetNullGroupsBlank = Arguments.SetNullGroupsBlank/>
	...
	<cffunction name="get" returntype="Array" output="false" access="public">
		...
		<cfset var Pattern = CreateObject("java","java.util.regex.Pattern").compile( Arguments.Regex , parseFlags(Arguments.Flags) )/>
	...
	<cffunction name="getFirstNoCase" returntype="String" output="false" access="public">
		<cfargument name="Text"    type="String"/>
		<cfargument name="Regex"   type="String"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>

		<cfreturn This.getFirst
			( ArgumentCollection = Arguments
			, Flags = BitOr( Arguments.Flags , This.Flags.CASE_INSENSITIVE )
			) />
	</cffunction>
	...
	<cffunction name="getGroupsNoCase" returntype="Array" output="false" access="public">
		<cfargument name="Text"    type="String"/>
		<cfargument name="Regex"   type="String"/>
		<cfargument name="SetNullGroupsBlank" type="Boolean" default="#This.SetNullGroupsBlank#"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>

		<cfreturn This.getGroups
			( ArgumentCollection = Arguments
			, Flags = BitOr( Arguments.Flags , This.Flags.CASE_INSENSITIVE )
			) />
	</cffunction>
	...
	<cffunction name="matchNoCase" returntype="Array" output="false" access="public">
		<cfargument name="Regex"   type="String"/>
		<cfargument name="Text"    type="String"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>
	...
	<cffunction name="matchFirstNoCase" returntype="String" output="false" access="public">
		<cfargument name="Regex"   type="String"/>
		<cfargument name="Text"    type="String"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>
	...
	<cffunction name="matchGroupsNoCase" returntype="Array" output="false" access="public">
		<cfargument name="Regex"   type="String"/>
		<cfargument name="Text"    type="String"/>
		<cfargument name="SetNullGroupsBlank" type="Boolean" default="#This.SetNullGroupsBlank#"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>
	...
	<cffunction name="matchesNoCase" returntype="Boolean" output="false" access="public">
		<cfargument name="Text"    type="String"/>
		<cfargument name="Regex"   type="String"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>

		<cfreturn This.matches
			( ArgumentCollection = Arguments
			, Flags = BitOr( Arguments.Flags , This.Flags.CASE_INSENSITIVE )
			) />
	</cffunction>
	...
	<cffunction name="splitNoCase" returntype="Array" output="false" access="public">
		<cfargument name="Text"    type="String"/>
		<cfargument name="Regex"   type="String"/>
		<cfargument name="Flags"   default="#This.DefaultFlags#"/>
	...
	<cffunction name="escape" returntype="String" output="false" access="public"
		hint="Note: It is recommended to use \Qtext\E instead of this function.">
		<cfargument name="Text" type="String"/>
